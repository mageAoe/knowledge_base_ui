import{_ as s,c as a,o as n,O as t}from"./chunks/framework.41379913.js";const b=JSON.parse('{"title":"mongoDB","description":"","frontmatter":{},"headers":[],"relativePath":"framework/mongoDb/index.md"}'),e={name:"framework/mongoDb/index.md"},o=t(`<h1 id="mongodb" tabindex="-1">mongoDB <a class="header-anchor" href="#mongodb" aria-label="Permalink to &quot;mongoDB&quot;">​</a></h1><h2 id="mongodb简介" tabindex="-1">mongoDB简介 <a class="header-anchor" href="#mongodb简介" aria-label="Permalink to &quot;mongoDB简介&quot;">​</a></h2><p>什么是mongodb</p><p>mongodb是由c++语言编写的，是一个基于分布式文件存储的开源数据库系统</p><p>在高负荷的情况下，添加更多的节点，可以保证服务器性能</p><p>mongodb 目的是在为web应用提供可扩展的高性能数据存储方案</p><p>mobgodb是以 key：value的键值对的形式存在，与json相似</p><p>1.database 数据库</p><p>2.collection 集合或文档</p><blockquote><blockquote><p>mongod 启动mongodb</p></blockquote></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&gt;show dbs</span></span>
...
<span class="line"><span style="color:#A6ACCD;">//切换数据库目录</span></span></code></pre></div><blockquote><blockquote><p>数据库命名</p></blockquote></blockquote><p>不能是控字符串（“”）</p><p>不能含有 空格 、 $ /，\\</p><p>应该全是 小写</p><p>有一些数据库名是保留的 。admin</p><p>local 数据库不能被复制 ，只能存储当前服务器的数据</p><blockquote><p>文档的键是字符串，键可以使用任意utf-8</p></blockquote><p>-- 键不能含有\\0 这个字符用来表示键结尾的</p><p>--和$有特别的意义，只有在特定环境下使用</p><p>--以下划线‘_’开头的键是保留的</p><table><thead><tr><th>Timestamp</th><th>时间戳。记录文档修改和添加的具体时间</th></tr></thead><tbody><tr><td>Object</td><td>用于内嵌文档</td></tr><tr><td>Null</td><td>用于创建空值</td></tr><tr><td>symbol</td><td>符号。该数据类型基本上等同于字符串类型，但不同的是，它一般采用特殊符号类型的语言</td></tr><tr><td>Data</td><td>日期时间。用unix时间格式来存储当前日期活时间，你可以指定自己的日期时间:创建data对象，传入年月日信息</td></tr><tr><td>object id</td><td>对象ID 用于创建文档ID</td></tr><tr><td>binary data</td><td>二进制数据</td></tr></tbody></table><blockquote><p>objectid objectid 类似一个主键，可以很快去生成：</p></blockquote><p>前4个字符串表示创建unix时间戳，格林尼治时间UTC时间，比北京时间晚了8个小时</p><p>接下来的3个字符节是机器标识符</p><p>紧接着的两个字符由进程id 组成PID</p><p>最后三个字符是随机数</p><blockquote><p>objectid保存了创建的时间戳，可以通过getTimestamp函数来获取文档的创建时间</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 在cmd中使用</span></span>
...
<span class="line"><span style="color:#A6ACCD;">//nModifind 修改</span></span></code></pre></div><blockquote><p>使用</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">db.mydata.update({ },{$set:{ }})</span></span>
...
<span class="line"><span style="color:#A6ACCD;">//upsert 在更新时如果没有当前条件匹配的文档，就会创造条件去更新</span></span></code></pre></div><p>参数说明</p><p>query ：update的查询条件，类似sql update</p><p>update：update的对象和一些更新的操作符（$in），</p><p>upsert：可选，如果不存在update的记录，是否插入objNew，true为插入，默认为false，不插入</p><p>multi：可选，mobgodb默认是false，只要更新找到的第一条记录，如果这个参数为true，就把俺条件查出来多条记录全部更新</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">#  插入单条数据</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">        ]</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><ul><li>状元笔记</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">db.collection.updateOne() 向指定集合更新单个文档</span></span>
...
<span class="line"><span style="color:#A6ACCD;">{ &quot;_id&quot; : ObjectId(&quot;59c8ba673b92ae498a5716b1&quot;), &quot;name&quot; : &quot;asd&quot;, &quot;age&quot; : &quot;30&quot;, &quot;status&quot; : &quot;xyz&quot; }</span></span></code></pre></div><h2 id="查询" tabindex="-1">查询 <a class="header-anchor" href="#查询" aria-label="Permalink to &quot;查询&quot;">​</a></h2><blockquote><p>查询数据</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">db.mydate.find(query,option)</span></span></code></pre></div><p>query:可选 ，使用查询操作符指定查询条件</p><p>option： 可选，查询时返回文档中所有键值</p><blockquote><p>pretty（），查询出来的数据是json格式的</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">db.mydate.find().pretty()</span></span></code></pre></div><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">findOen（）</span></span>
...
<span class="line"><span style="color:#A6ACCD;">.skip( //忽略)</span></span></code></pre></div><blockquote><p>多条件查询</p></blockquote><p>//这个只能使用不同条件进行查询 比如 ： name || size</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&gt;db.mydate.find(key1:value1,key2:value2).pretty()</span></span></code></pre></div><blockquote><p>多条件查询</p></blockquote><p>//可以使用相同的条件来查询不同的数据</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&gt;db.mydate.find(</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    }]</span></span>
<span class="line"><span style="color:#A6ACCD;">    </span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><blockquote><p>各种符号</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">$gt -- &gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">$eq -- =</span></span></code></pre></div><p>使用</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&gt;db.mydate.find({age:{$gt:20}}).pretty()</span></span>
<span class="line"><span style="color:#A6ACCD;">//查询年龄大于20的数据</span></span></code></pre></div><blockquote><p>排序</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">//升序</span></span>
<span class="line"><span style="color:#A6ACCD;">db.mydata.find().sort({key:+value}) // value是正值</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">//降序 value是负值</span></span></code></pre></div><blockquote><p>语法</p></blockquote><h2 id="mongodb-创建数据库-1" tabindex="-1">mongodb 创建数据库 <a class="header-anchor" href="#mongodb-创建数据库-1" aria-label="Permalink to &quot;mongodb 创建数据库&quot;">​</a></h2><p>use + 要创建的数据库名</p><p>db 查看 db.创建的数据库名.insert（{}） 中间插入的是一个对象</p><p>//查看数据库内容</p><p>db.aa.find()</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&gt;use aaa</span></span>
<span class="line"><span style="color:#A6ACCD;">&gt;db</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">db.dropDatabase()</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">//删除数据库，默认为test，可以通过db查看当前数据库名</span></span></code></pre></div><blockquote><p>创建集合</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">db.createCollection(&#39;ai&#39;,option)</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">{&#39;ok&#39;:1} //创建一个dev的数据库集合，大小，最大存5条数据</span></span></code></pre></div><table><thead><tr><th>capped</th><th>（可选）如果是true，则会创建固定集合，固定集合是指有着固定大小的集合，当达到最大值时，他会自动覆盖最早的文档，当该值为true时，必须指定size参数</th></tr></thead><tbody><tr><td>autoindexid</td><td>（可选）如果为true，自动在_id字段创建索引，默认为false</td></tr><tr><td>size</td><td>（可选）为固定集合指定一个最大值，如果capped为true，也需要指定该字段</td></tr><tr><td>max</td><td>（可选）指定固定集合中包含文档的最大数量</td></tr></tbody></table><blockquote><p>删除集合</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">db.collection.drop()</span></span></code></pre></div><blockquote><p>show tables 查询集合</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&gt;show tables</span></span>
<span class="line"><span style="color:#A6ACCD;">或者</span></span>
<span class="line"><span style="color:#A6ACCD;">&gt;show collections</span></span></code></pre></div><h2 id="删除文档" tabindex="-1">删除文档 <a class="header-anchor" href="#删除文档" aria-label="Permalink to &quot;删除文档&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&gt;db.mydata.remove({key:value})</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">//多条件删除</span></span>
<span class="line"><span style="color:#A6ACCD;">&gt;db.mydate.remove({$or[{key:value},{key:value}]})</span></span></code></pre></div><p>只删除一条数据</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&gt;db.mydate.remove({key:value},{justOne:true})</span></span></code></pre></div><h2 id="复习知识" tabindex="-1">复习知识 <a class="header-anchor" href="#复习知识" aria-label="Permalink to &quot;复习知识&quot;">​</a></h2><p>基本概念： 数据库（database） 集合（collection） 文档（document）</p><ol><li><p>show dbs 显示所有的数据库</p></li><li><p>ues + 数据库名 进入数据库 ，如果没有数据库名，就会新建一个库</p></li><li><p>use 进入表后会提示 switched to db xxxx</p></li><li><p>然后使用 show collection 查询集合</p></li><li><p>db 显示当前所在的数据库</p></li></ol><p>数据库的（增删改查）</p><pre><code>插入：insert
...
<span class="line"><span style="color:#A6ACCD;">	attempting to approximate collection names by parsing connectionStatus</span></span></code></pre></div><p>解决方案 原因是mongo设置了用户名和密码，所以登陆的时候需要指定用户名和密码</p><div class="language-cmd"><button title="Copy Code" class="copy"></button><span class="lang">cmd</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># mongodb://用户名:密码@localhost:</span><span style="color:#F78C6C;">27017</span></span>
<span class="line"><span style="color:#A6ACCD;">root@c87416afb49d:/# mongo mongodb://root@rootlocalhost:</span><span style="color:#F78C6C;">27017</span></span></code></pre></div>`,144),p=[o];function l(c,i,d,u,r,C){return n(),a("div",null,p)}const q=s(e,[["render",l]]);export{b as __pageData,q as default};
